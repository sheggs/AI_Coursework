...
clf = trainSVM()
#clf = loadModel()
print("NIST 1 Consitution")
pred = readOCR("./ocr/testing/NIST_1.png","./ocr/testing/NIST_1_ground_truth.txt", clf)
print(toString(pred))
print("NIST 2 Numbers")
pred = readOCR("./ocr/testing/NIST_2.png","./ocr/testing/NIST_2_ground_truth.txt", clf)
print(toString(pred))
