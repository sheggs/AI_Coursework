...
training_files = ['./ocr/training/training.png']
...
for files in training_files:
    ...
    for i in letters:
        if string_counter > 60:
            string_counter = 0
        if not os.path.exists("./training_type"):
            os.mkdir("./training_type")
        if not os.path.exists("./training_type/" + str(folder_string[string_counter])):
            os.mkdir("./training_type/" + str(folder_string[string_counter]))
