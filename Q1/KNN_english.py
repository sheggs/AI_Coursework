...
def trainKNN():
    ...
    try:
        dump(knn_clf,'knn_eng.joblib')
    except FileNotFoundError:
        io.open('knn_eng.joblib')
        dump(knn_clf,'knn_eng.joblib')
    print(y_knn_pred)
...
knn_clf = trainKNN()
pred = readOCR("./ocr/testing/adobe.png","./ocr/testing/adobe_ground_truth.txt", knn_clf)
print(toString(pred))
