...
def trainSVM():
    ...
    try:
        dump(clf,'svm_turkish.joblib')
    except FileNotFoundError:
        io.open('svm_turkish.joblib')
        dump(clf,'svm_turkish.joblib')
    print(y_knn_pred)
...
def readOCR(filename, truth, clf):
  ...
  print(asarray(hog_converted).shape)
...
def loadModel():
    return load("svm_turkish.joblib")
...
pred = readOCR("./ocr/testing/turkish_testing1.png","./ocr/testing/turkish_testing1.txt", clf)

#print(toString(pred))
print("Turkish Testing2")
pred = readOCR("./ocr/testing/turkish_testing2.png","./ocr/testing/turkish_testing2.txt", clf)
#print(toString(pred))
